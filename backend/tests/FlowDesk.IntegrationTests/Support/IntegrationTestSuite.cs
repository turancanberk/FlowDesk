...
/// <summary>
/// Shares one PostgreSQL, one RabbitMQ, one Azurite and one Redis container
/// across every integration test class.
/// </summary>
/// <remarks>
...
///
/// All four are real services rather than substitutes. The behaviour these
/// tests exist to check — constraints, row locking, query filters, topic
/// routing, acknowledgement, object keys, key expiry — belongs to the services
/// themselves,
